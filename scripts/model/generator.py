...
from .blocks_gan import (DiscriminatorBlock, DiscriminatorTop,
...
class GSynthesis(nn.Module):
    ...
    def __init__(self, dlatent_size=512, num_channels=3, resolution=256,
...
class Generator(nn.Module):
    ...
    def forward(self, latents_in, depth=6, alpha=0, labels_in=None):
        """

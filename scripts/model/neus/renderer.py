...
class NeuSRenderer:
    ...
    def render(self, rays_o, rays_d, near, far, perturb_overwrite=-1,  data=None, background_rgb=None, cos_anneal_ratio=0.0,
               siren_network=None, shape_latent=None, color_latent=None, second_order=None, compute_color=True, compute_sample_dist=False, blend_background=False):
